...
def query_database(self, keyword: str, start_date=None, end_date=None):
    ...
    between the start and end dates (if date parameters are input). Returns list of dict, each dict represents a row in
    the table, where keys are the column names"""
